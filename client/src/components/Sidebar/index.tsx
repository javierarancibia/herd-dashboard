        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Puestos de Trabajo --> */}
              <li>
                <NavLink
                  to="/main/puestos-de-trabajo"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('puestos-de-trabajo') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/main/mis-postulaciones"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('mis-postulaciones') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/main/forms' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
